...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("First bean helloworld = second bean helloworld: " + (bean.equals(beanHelloWorld2)));
        System.out.println("First bean cat = second bean cat: " + (cat1.equals(cat2)));
    }
}